...
> 我这里面部署成功了但是跳转出现404了
>
> 原因：跳转的地址是：https://li-qingchen.github.io/blog.html，但实际上应该是：https://li-qingchen.github.io/learn-jekyll/blog.html
>
> 解决办法：
>
> 简单讲一下我怎么做的：
...
>
> ```yml
> domain: li-qingchen.github.io   
> url: https://li-qingchen.github.io
> baseurl: /learn-jekyll
> ```
>
> 这里整体列一下改了那些文件和代码：
>
...
>     - jekyll-seo-tag
>   
>   domain: li-qingchen.github.io       # if you want to force HTTPS, specify the domain without the http at the start, e.g. example.com
>   url: https://li-qingchen.github.io  # the base hostname and protocol for your site, e.g. http://example.com    # place folder name if the site is served in a subfolder
>   baseurl: /learn-jekyll
>   ```
>
> - blog.html：
...
最后访问OK：https://li-qingchen.github.io/learn-jekyll

## END

项目Demo地址：https://github.com/li-qingchen/learn-jekyll
