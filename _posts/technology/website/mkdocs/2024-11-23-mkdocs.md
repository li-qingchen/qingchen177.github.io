...
remote:      https://github.com/li-qingchen/mkdocs-demo/pull/new/gh-pages
remote: 
To github.com:/li-qingchen/mkdocs-demo.git
 * [new branch]      gh-pages -> gh-pages
INFO    -  Your documentation should shortly be available at: https://.github.io/li-qingchen/mkdocs-demo/
```

不是哥们这也太方便啦

https://li-qingchen.github.io/mkdocs-demo/

## END

项目Demo地址：https://github.com/li-qingchen/mkdocs-demo
