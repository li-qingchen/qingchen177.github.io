...
```shell
mdbook init learn-mdbook
####
qingchen@liqingchen:~/workspace/projects$ mdbook init learn-mdbook

Do you want a .gitignore to be created? (y/n)
y
What title would you like to give the book? 
qingchen-learn-mdbook
...
https://li-qingchen.github.io/learn-mdbook/

## END

项目Demo地址：https://github.com/li-qingchen/learn-mdbook
